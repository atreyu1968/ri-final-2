...
const ActionForm: React.FC<ActionFormProps> = ({ onSubmit, onClose, initialData }) => {
  ...
  const validateStep = () => {
    ...
    if (stepId === 'participants' && formData.studentParticipants === 0 && formData.teacherParticipants === 0) {
      setError('Debe haber al menos un participante (estudiante o profesor)');
      return false;
    }
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Validate at least one type of participant
    if (formData.studentParticipants === 0 && formData.teacherParticipants === 0) {
      setError('Debe haber al menos un participante (estudiante o profesor)');
      return;
    }
